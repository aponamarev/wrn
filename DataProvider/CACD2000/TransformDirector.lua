...
function TransformDirector:assemble()
  ...
  if self.opt.randflip then self.container:randflip(self.opt.randflip.vertircal) end
  ...
  if self.opt.randcrop then self.container:randcrop(self.opt.randcrop) end
